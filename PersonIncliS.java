...
//-------------------------------------------------------------------------------
class PersonIncliS implements ProblemData, Forceable {

    private String title = "Stationary person on inclined surface";
    ...
    //---------------------------------------------------------------------------
    // the PersonIncliS constructor:
    public PersonIncliS (String an, String w, String ac) {
        String angleIn = an;
        String weightIn = w;
