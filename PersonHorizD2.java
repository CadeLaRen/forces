// PersonHorizD2.java
// copyright, Peter Signell, 6/7/97
//-------------------------------------------------------------------------------
import java.awt.*;
import java.lang.Math;
//-------------------------------------------------------------------------------
class PersonHorizD2 implements ProblemData, Forceable {
    ...
    //---------------------------------------------------------------------------
    // the PersonHorizD2 constructor:
    public PersonHorizD2 (String an, String w, String ac) {
        String angleIn = an;
        String weightIn = w;
